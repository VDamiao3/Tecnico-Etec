...
<html>
    ...
    <body>
        <div id="nav"> <!-- AQUI É A DIV QUE FICA FIXADA -->
            <div id=" alinhartop " style="margin-left:-300px">
            <ul >
               ...
               <li><a 
                ...
                <li style="float: left"class="search" >
		<input type="text"/><input class="searchbutton" type="submit" value=""/>
            ...
            <li>
                <input 
                    <font   type="text" maxlength="30" name="usu" value="ex.usuario@gmail.com" 
            ...
            <div id="usu">
                ...
                <form action="formulario02.php " method="POST" > <!--input comoando para criar uma janela para digitar--, POST(SIGILO)
                    ...
                    <font color="#999">Usuario</font></form>
            </div>
            <div id="sen">
                 <form action="formulario02.php " method="POST" >
                <font color="#999">Senha<input type="password" maxlength="15" name="sen"></input></font>
                 </form>
                </div>
            
            <div id="cad">
             <form action="formulario02.php " method="POST" >
                 <a class="bottom">Cadastrar</a></form>
            </div>
		...
		<div class="scroll"></div>
            ...
            <a class="back" 
              ...
              <div id="meio" style="margin-top: 98px; background-color: #333333; " >
               <figure>
