...
<html>
    ...
    <style>
        body{    /* CODIGO DE PESQUISA FIXED*/
            margin:0px;
            padding:0px;           
            font-family:Arial;
			 background:#eaa78a  no-repeat top center;
        }
		a.back{
            width:256px;
            height:73px;
...
* {margin: 0; padding: 0;}
		...
		figcaption {padding-left: 20px;color: #fff;
                            font-family: "Kaushan Script","Lato","arial"; font-size: 22px;
	 ...
	 #meio
	 {
		 ...
		 height:auto;
                 ...
                 /* CONTEUDO DO SITE QUE VAI SE MEXER*/
                 .grow img {
  height: 200px;
  width: 200px;
...
#final
{
    ...
    <body>
        ...
        <div class="info">
            <a class="back" 
               href="http://tympanus.net/codrops/2009/12/11/fixed-fade-out-menu-a-css-and-jquery-tutorial/"></a>
        </div>
        ...
        <script type="text/javascript">
          ...
          <header>
              ...
              <div id="marca" aling="left"
                   style="float:left;width: auto ;height:auto;background-color:#333333; margin-top:-6% ">
              ...
              <div id="meio" >
               <figure>
                ...
                <div id="slider" style="margin-top:auto;">
                  <center>
                      <a href="#" class="trs"><img src="imagem1.jpg" alt="Legenda da imagem 1" 
                      style="margin-left:27%" width="90%" height="300"></img>
            </a>
                    <a href="#" class="trs"><img src="imagem3.jpg" alt="Legenda da imagem 2" 
  ...
  <img src=
       ...
       alt="portrait" width="50" height="100" style="margin-top:80px; margin-left: 10% "></img>
       ...
       <img src=
           ...
           <img src="http://modafeminina.biz/wp-content/uploads/2014/03/Louis-Vuitton1.jpg" 
               ...
               <img src="http://www.todavoce.com.br/wp-content/uploads/2010/06/historia-bolsas-13.jpg"  
                    width="50" height="100" style="margin-top:80px;margin-left: 10%"></img>
